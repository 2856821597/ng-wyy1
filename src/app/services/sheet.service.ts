...
import { SongSheet, Song } from './data-type/common.service';
...
export class SheetService {
  ...
  playSheet(id: number): Observable<Song[]> {
      return this.getSongSheetDetail(id).pipe(pluck('tracks'), switchMap( (tracks: any) => this.songService.getSongList(tracks)));
  }
}
